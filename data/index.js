...
const data = {
  ...
  rules: {
    ...
    prize1: ['大嶼山片藍造工房藍染體驗工作坊一節（價值$780）', '藍染和尚袋一個（價值$440）','「堅守大嶼」旗幟一面', '綠色和平2022年〈山海大嶼〉年曆','優先參與「與大師同攝」延伸活動的資格'],
    prize2: ['「堅守大嶼」旗幟一面', '綠色和平2022年〈山海大嶼〉年曆', '優先參與「與大師同攝」延伸活動的資格'],
    prize3: ['綠色和平2022年〈山海大嶼〉年曆一個','優先參與「與大師同攝」延伸活動的資格'],
  },
  photowalk: {
    itemHeadline: '注意事項',
    items: [
